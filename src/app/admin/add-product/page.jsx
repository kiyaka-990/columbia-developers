...
export default function AddProductPage() {
    const [formData, setFormData] = useState({ title: "", price: "", category: "", img: "" });
    ...
    return (
        <div className="container py-5">
            ...
            <form onSubmit={handleSubmit} className="card p-4 shadow-sm">
                ...
                <button type="submit" className="btn btn-primary" style={{backgroundColor: '#e23212', border: 'none'}}>Save Product</button>
            </form>
        </div>
    );
}