                    ...
                    <div className="col-lg-7">
                        <div className="title-area portfolio-area-content-text-extra-style">
                            <span className="sub-title">
                                <Image src="/main-assets/img/icon/section-subtitle-icon.svg" alt="img" width={60} height={60}/>Recent Work
                            </span>
                            ...
                            <div className="col-lg-4" key={index}>
                                <div className="portfolio-card style2">
                                    <div className="portfolio-card-thumb">
                                        <Image src={img.imgSrc} alt={`project-${index + 1}`} />
                                    ...
                                    <div className="portfolio-card-details">
                                        ...
                                        <p className="portofolio-card-text">Building since 09,01,2014</p>
