                                ...
                                <tbody>
                                    <tr className="wishlist_item">
                                        ...
                                        <td className="product-thumbnail">
                                            <Link href="/pages/innerpage/shop-details"><Image src="/main-assets/img/product/product_1_4.jpg" className="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="image" width={580} height={580} /></Link>
                                        </td>
                                        <td className="product-name">
                                            <Link href="/pages/innerpage/shop-details">Chainsaw Machine</Link>
                                        </td>
                                        <td className="product-price wishlist-product-price-flex">
                                            <span className="woocommerce-Price-amount amount"><bdi><span className="woocommerce-Price-currencySymbol">Ksh</span>45.00</bdi></span>
                                        </td>
                                    ...
                                    <tr className="wishlist_item">
                                        ...
                                        <td className="product-thumbnail">
                                            <Link href="/pages/innerpage/shop-details"><Image src="/main-assets/img/product/product_1_5.jpg" className="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="image" width={580} height={580} /></Link>
                                        </td>
                                        <td className="product-name">
                                            <Link href="/pages/innerpage/shop-details">Construction Hat</Link>
                                        </td>
                                        <td className="product-price wishlist-product-price-flex">
                                            <ins><span className="woocommerce-Price-amount amount"><bdi><span className="woocommerce-Price-currencySymbol">Ksh</span>18.00</bdi></span></ins>
                                            <del><span className="woocommerce-Price-amount amount"><bdi><span className="woocommerce-Price-currencySymbol">Ksh</span>20.00</bdi></span></del>
                                        </td>
                                        <td className="product-stock">
                                    ...
                                    <tr className="wishlist_item">
                                        ...
                                        <td className="product-thumbnail">
                                            <Link href="/pages/innerpage/shop-details"><Image src="/main-assets/img/product/product_1_6.jpg" className="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="image" width={580} height={580} /></Link>
                                        </td>
                                        <td className="product-name">
                                            <Link href="/pages/innerpage/shop-details">Sparta Demolition Hammer</Link>
                                        </td>
                                        <td className="product-price wishlist-product-price-flex">
                                            <ins><span className="woocommerce-Price-amount amount"><bdi><span className="woocommerce-Price-currencySymbol">Ksh</span>18.00</bdi></span></ins>
                                            <del><span className="woocommerce-Price-amount amount"><bdi><span className="woocommerce-Price-currencySymbol">Ksh</span>20.00</bdi></span></del>
