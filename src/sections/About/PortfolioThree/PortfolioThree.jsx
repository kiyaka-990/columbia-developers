        ...
        <div className="portfolio-slider1 overflow-hidden">
          <Slider {...settings}>
            <div>
              <div className="portfolio-card" style={{ margin: "0px 1rem" }}>
                <div className="portfolio-card-thumb">
                  <Image src="/main-assets/img/project/project1_1.png" alt="img" width={812} height={450}/>
                  <Link
            ...
            <div>
              <div className="portfolio-card" style={{ margin: "0px 1rem" }}>
                <div className="portfolio-card-thumb">
                  <Image src="/main-assets/img/project/project1_2.png" alt="img"  width={812} height={450}/>
                  <Link
                    className="icon-btn popup-image"
            ...
            <div>
              <div className="portfolio-card" style={{ margin: "0px 1rem" }}>
                <div className="portfolio-card-thumb">
                  <Image src="/main-assets/img/project/project1_3.png" alt="img"  width={812} height={450}/>
                  <Link
                    className="icon-btn popup-image"
