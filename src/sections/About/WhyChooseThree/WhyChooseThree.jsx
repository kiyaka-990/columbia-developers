        ...
        <div className="row gy-50 align-items-center">
            ...
            <div className="wcu-card-wrap left-align">
              <div className="wcu-card">
                <div className="wcu-card-icon">
                  <Image src="/main-assets/img/icon/why-icon1-1.svg" alt="img" width={60} height={60} />
                </div>
              ...
              <div className="wcu-card">
                <div className="wcu-card-icon">
                  <Image src="/main-assets/img/icon/why-icon1-2.svg" alt="img" width={60} height={60}/>
                </div>
                <div className="wcu-card-details">
              ...
              <div className="wcu-card">
                <div className="wcu-card-icon">
                  <Image src="/main-assets/img/icon/why-icon1-3.svg" alt="img" width={60}  height={60}/>
                </div>
                <div className="wcu-card-details">
          ...
          <div className="col-xl-4 col-md-6 order-xl-3">
            <div className="wcu-card-wrap right-align">
              <div className="wcu-card">
                <div className="wcu-card-icon">
                  <Image src="/main-assets/img/icon/why-icon1-4.svg" alt="img" width={60} height={60}/>
                </div>
                <div className="wcu-card-details">
              ...
              <div className="wcu-card">
                <div className="wcu-card-icon">
                  <Image src="/main-assets/img/icon/why-icon1-5.svg" alt="img" width={60} height={60}/>
                </div>
                <div className="wcu-card-details">
              ...
              <div className="wcu-card">
                <div className="wcu-card-icon">
                  <Image src="/main-assets/img/icon/why-icon1-6.svg" alt="img" width={60} height={60}/>
                </div>
                <div className="wcu-card-details">
          ...
          <div className="col-xl-4">
            <div className="wcu-thumb1-1">
              <Image src="/main-assets/img/normal/why_1-1.png" alt="img" width={60} height={60}/>
            </div>
          </div>
        </div>
      </div>
